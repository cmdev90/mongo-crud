...
var Instance = (function (){
  ...
  var collection = instance.prototype.collection = function (collection) {
...
var Manager = function (url) {
      ...
      manager.prototype.getCollection = function (collection) {
        console.log(this);
        instance.collection(collection);
        return instance;
      };

      return new manager(url).getCollection;
...
module.exports = (function () {
  ...
  InstanceManager.prototype.create = function(instance, url) {
    this[instance] = Manager(url);
  };
