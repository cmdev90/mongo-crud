module.exports = (function () {
   ...
   * @return {null}
   */
  var update = Instance.prototype.update = function (collection, criteria, callback) {
    var collectionName = typeof collection === 'string' ? collection.toLowerCase() : null
  ...
  var extend = InstanceManager.prototype.extend = function (options) {
    this.host = options && options.host ? options.host : this.host;
    this.port = options && options.port ? options.port : this.port;
  }

  InstanceManager.prototype.create = function(alias, dbName, callback) {
    this[alias] = new Instance('mongodb://' +  this.host + ':' + this.port + '/' + dbName, callback);
  };
